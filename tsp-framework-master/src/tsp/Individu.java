...
public class Individu {
	...
	/**
	 * @param aucun param̬tre en entr̩e
	 * @return ne retourne rien, modifie directement l'individu :4-change non s̩quentiel ou double-bridge
	 * le parcours : 0 ... i i+1 ... j j+1 ... k k+1 ... l l+1 ... 
	 * est modifi̩ en : 0...i k+1 ... l j+1 ... k i+1 ... j l+1 ...
	 * Les indices i,j,k et l sont choisis al̩atoirement
	 */
	...
	/**
	 * @param seuil, donne la probabilit̩ de swaper les deux villes al̩atoirement
	 * @return ne retourne rien, modifie directement l'individu en swapant deux de ses g̬nes al̩atoirement
	 */
